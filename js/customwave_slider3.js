...
$(document).ready(function() {
    ...
    //     var dataId = $('.slick-current').attr("data-slick-index");    
    //     if(dataId == 0){
    //         $(".section-top-keyvisual .animate_gorup.one,.section-top-keyvisual .m_img.one").removeClass("active");
    //     }
    //     if(dataId == 1){
    //         $(".section-top-keyvisual .animate_gorup.two,.section-top-keyvisual .m_img.two").removeClass("active");
    //     }
    //     if(dataId == 2){
    //         $(".section-top-keyvisual .animate_gorup.three,.section-top-keyvisual .m_img.three").removeClass("active");
    //     }
    // });
